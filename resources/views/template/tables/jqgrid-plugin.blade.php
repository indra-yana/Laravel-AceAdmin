...
@section('title', 'JQGrid Plugin')

@section('styles')
  <!-- Add custom styles here -->
  <link rel="stylesheet" href="{{ asset('ace-master/assets/css/jquery-ui.min.css') }}" />
  <link rel="stylesheet" href="{{ asset('ace-master/assets/css/bootstrap-datepicker3.min.css') }}" />
  <link rel="stylesheet" href="{{ asset('ace-master/assets/css/ui.jqgrid.min.css') }}" />
@endsection
...
@section('scripts')
  ...
  <script src="{{ asset('ace-master/assets/js/jquery.jqGrid.min.js') }}"></script>
  <script src="{{ asset('ace-master/assets/js/grid.locale-en.js') }}"></script>
