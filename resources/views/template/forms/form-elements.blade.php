...
@section('styles')
  ...
  <link rel="stylesheet" href="{{ asset('ace-master/assets/css/chosen.min.css') }}" />
  <link rel="stylesheet" href="{{ asset('ace-master/assets/css/bootstrap-datepicker3.min.css') }}" />
  <link rel="stylesheet" href="{{ asset('ace-master/assets/css/bootstrap-timepicker.min.css') }}" />
  <link rel="stylesheet" href="{{ asset('ace-master/assets/css/daterangepicker.min.css') }}" />
...
@section('scripts')
  ...
  <script src="{{ asset('ace-master/assets/js/bootstrap-timepicker.min.js') }}"></script>
  <script src="{{ asset('ace-master/assets/js/moment.min.js') }}"></script>
  <script src="{{ asset('ace-master/assets/js/daterangepicker.min.js') }}"></script>
  ...
  <script src="{{ asset('ace-master/assets/js/jquery.knob.min.js') }}"></script>
  <script src="{{ asset('ace-master/assets/js/autosize.min.js') }}"></script>
  <script src="{{ asset('ace-master/assets/js/jquery.inputlimiter.min.js') }}"></script>
  <script src="{{ asset('ace-master/assets/js/jquery.maskedinput.min.js') }}"></script>
  <script src="{{ asset('ace-master/assets/js/bootstrap-tag.min.js') }}"></script>
