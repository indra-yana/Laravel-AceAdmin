...
@section('scripts')
  ...
  <script src="{{ asset('ace-master/assets/js/spin.js') }}"></script>
      ...
      */
      ...
      $('#gritter-regular').on(ace.click_event, function(){
        $.gritter.add({
          ...
          image: "{{ asset('ace-master/assets/images/avatars/avatar1.png') }}", //in Ace demo ./dist will be replaced by correct assets path
          sticky: false,
          time: '',
      ...
      $('#gritter-sticky').on(ace.click_event, function(){
        var unique_id = $.gritter.add({
          ...
          image: "{{ asset('ace-master/assets/images/avatars/avatar.png') }}",
          sticky: true,
          time: '',
      ...
      $('#gritter-max3').on(ace.click_event, function(){
        $.gritter.add({
          ...
          image: "{{ asset('ace-master/assets/images/avatars/avatar3.png') }}", //in Ace demo ./dist will be replaced by correct assets path
          sticky: false,
