...
@section('title', 'Wizard Validation')
...
@section('scripts')
  ...
  <script src="{{ asset('ace-master/assets/js/wizard.min.js') }}"></script>
  <script src="{{ asset('ace-master/assets/js/jquery.validate.min.js') }}"></script>
  <script src="{{ asset('ace-master/assets/js/jquery-additional-methods.min.js') }}"></script>
